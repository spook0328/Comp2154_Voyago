        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    country_language = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_itineraries_AspNetUsers_user_id",
                        column: x => x.user_id,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_itineraries_countries_country_id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    phrase_id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    country_id = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_phrases", x => x.phrase_id);
                    table.ForeignKey(
                        name: "FK_phrases_countries_country_id",
                        column: x => x.country_id,
                        principalTable: "countries",
                        principalColumn: "country_id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_itinerary_items", x => x.itinerary_item_id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_locations_itinerary_items_itinerary_item_id",
                        column: x => x.itinerary_item_id,
                        principalTable: "itinerary_items",
                        principalColumn: "itinerary_item_id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_itineraries_country_id",
                table: "itineraries",
                column: "country_id");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_locations_itinerary_item_id",
                table: "locations",
                column: "itinerary_item_id");

            migrationBuilder.CreateIndex(
                name: "IX_phrases_country_id",
                table: "phrases",
                column: "country_id");
        }
